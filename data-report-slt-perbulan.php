      ...
      <div id="page-content-wrapper">
            ...
            <div class="container">
                  <div class="row">
                        <div class="col-lg-12">
                              <div class="container">
                                    <h1 class="text-center font-weight-bold" style="color: #565757;">SLT Data Report Permonth</h1>
                                    <br>
                                    <div style="overflow-x : auto;">
                                          <div class="container">
                                                ...
                                                <div class="row g-4">
                                                        <div class="col-auto">
                                                            <a href="data-report-slt.php"><button class=" btn btn-warning text-white">SLT Data Report</button></a>
                                                        </div>
                                                </div>
                                                <br>
                                                <table id="example" class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = "SELECT * FROM slt WHERE periode = $bulan.$tahun";
