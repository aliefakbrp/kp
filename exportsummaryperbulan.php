...
// 304/304L
($bulan == "")?$total304304L = mysqli_query($koneksi, "SELECT * FROM tbl_report where Grade = '304/304L'"):$total304304L = mysqli_query($koneksi, "SELECT * FROM tbl_report where Grade = '304/304L' AND tanggal = $bulan.$tahun");
$jmp304304L=[];
$jpslt304304L=[];
$jkw304304L=[];
$jbc304304L=[];
...
header("Content-Disposition: attachment; filename=summarymount$bulan/$tahun.xls");                         
?>